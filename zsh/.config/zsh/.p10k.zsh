# Generated by Powerlevel10k configuration wizard on 2026-06-10 at 23:27 AEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%f'          # default
      local      clean='%F{#a6e3a1}' # green
      local     staged='%F{#74c7ec}' # sapphire
      local   modified='%F{#f9e2af}' # yellow
      local  untracked='%F{#89b4fa}' # blue
      local conflicted='%F{#f38ba8}' # red
    else
      # Styling for incomplete and stale Git status.
      local       meta='%F{#6c7086}' # overlay0
      local      clean='%F{#6c7086}' # overlay0
      local     staged='%F{#6c7086}' # overlay0
      local   modified='%F{#6c7086}' # overlay0
      local  untracked='%F{#6c7086}' # overlay0
      local conflicted='%F{#6c7086}' # overlay0
    fi
  ...
  # p10k color overrides
  # need to also change in place in .p10k.zsh in my_git_formatter
  #     local       meta='%f'          # default
  #     local      clean='%F{#a6e3a1}' # green
  #     local     staged='%F{#74c7ec}' # sapphire
  #     local   modified='%F{#f9e2af}' # yellow
  ...
  #     local  untracked='%F{#6c7086}' # overlay0
  #     local conflicted='%F{#6c7086}' # overlay0
  # then search "+42 if have staged" and change to
  # (( VCS_STATUS_NUM_STAGED   )) && res+=" ${staged}+${VCS_STATUS_NUM_STAGED}"
  #                                           ^^^^^^
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#89dceb'     # sky
  ...
  typeset -g POWERLEVEL9K_TODO_FOREGROUND='#b4befe'
  typeset -g POWERLEVEL9K_TASKWARRIOR_FOREGROUND='#89dceb'
  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND='#b4befe'
